<?php
//Posting URL Format
//http://members.nutritionsolutionslifestyle.com/api/subscription/sync-start-to-thursday.php?auth=19Ic2ovwShM7akwPX5dZ4zvrITl3aMX
...
if (isset($_GET['auth'])) {
    if ($_GET['auth'] === '19Ic2ovwShM7akwPX5dZ4zvrITl3aMX') {
        ...
        */
        ...
        //This two lines would add seven days to the next bill date
